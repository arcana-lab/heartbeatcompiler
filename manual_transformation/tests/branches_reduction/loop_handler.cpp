...
extern "C" {
  ...
  int64_t loop_handler (
      ...
      uint64_t (*f[])(uint64_t *, uint64_t *, void **, uint64_t, void *, uint64_t),
      uint64_t myLevel,
    ...
    *returnLevel = splittingLevel;
    ...
    taskparts::tpalrts_promote_via_nativefj([&] {
      (*f[splittingLevel])(startIterationsFirstHalf, maxIterationsFirstHalf, (void **)liveInEnvironmentsFirstHalf, splittingLevel, liveOutEnvironment, 0);
    }, [&] {
      (*f[splittingLevel])(startIterationsSecondHalf, maxIterationsSecondHalf, (void **)liveInEnvironmentsSecondHalf, splittingLevel, liveOutEnvironment, 1);
  ...
  void loop_dispatcher (
    ...
    taskparts::benchmark_nativeforkjoin([&] (auto sched) {
        (*f)(startIterations, maxIterations, liveInEnvironments, 0, nullptr, 0);
    });
