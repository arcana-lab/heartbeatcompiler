...
/*----< kmeans_clustering() >---------------------------------------------*/
float** kmeans_hb_compiler(float **feature,    /* in: [npoints][nfeatures] */
                          int     nfeatures,
                          int     npoints,
                          int     nclusters,
                          float   threshold,
...
int cluster_hb_compiler(int numObjects, int numAttributes, float **attributes, int num_nclusters, float threshold, float ***cluster_centres) {
  int     nclusters;
  int    *membership;
  ...
  tmp_cluster_centres = kmeans_hb_compiler(attributes,
				      numAttributes,
				      numObjects,
				      nclusters,
				      threshold,
