...
colors = ["tomato", "darkorange", "yellowgreen", "turquoise", "cornflowerblue", "mediumpurple", "purple", "pink"]
techniques = ['opencilk', 'openmp_static', 'openmp_guided', 'heartbeat_versioning', 'heartbeat_versioning_leftover_splittable']
technique_names = ['OpenCilk', 'OpenMP (Static)', 'OpenMP (Guided)', 'Heartbeat (versioning)', 'Heartbeat (versioning leftover splittable)']
configs = ['1', '2', '4', '8', '16', '16_2_sockets', '32_2_sockets', '56_2_sockets']
config_names = ['1 Physical Core', '2 Physical Cores', '4 Physical Cores', '8 Physical Cores', '16 Physical Cores', '16 Physical Cores - 2 Sockets', '32 Physical Cores - 2 Sockets', '56 Physical Cores - 2 Sockets']
